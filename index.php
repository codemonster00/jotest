                ...
                <div class="row">
                    ...
                    <!-- <div class="col-lg-2">
                        <div class="header-right-menu">
                            <ul>
                                <li><a href="#" class="post-jobs">GET HIRED</a></li>
                            </ul>
                        </div>
                    </div> -->
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="banner-search">
                            <h2>Survey Evaluation on FeDex Stores</h2>
                ...
                <div class="col-lg-12">
                    <div class="site-heading" style="width: 80% !important;">
                        ...
                        <p>We are selected company to work for companies convenience and promote all services rendered
                            ...
                            qualified individuals for Post Office, Bank Mobile App / ATM Machine and Walmart Stores
                            shopping evaluation survey; It's fun, rewarding. You are never obligated to accept an
